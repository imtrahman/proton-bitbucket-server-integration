...
async function protonenv(templateName) {
 ...
 try { 
    const data = await proton.getEnvironmentTemplate(envparams).promise();
    console.log(data);
    template_exist = data.environmentTemplate.name // successful response
